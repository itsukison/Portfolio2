    ...
    <section className="bg-[#CCCCB2] min-h-[100dvh] md:min-h-[80vh] text-deep-black border-t border-black/10">
      <div className="container mx-auto h-full flex flex-col md:flex-row border-l border-r border-black/10 bg-[#CCCCB2]">
        ...
        <div className="w-full md:w-1/4 p-6 md:p-10 border-b md:border-b-0 md:border-r border-black/10 flex flex-col justify-between">
          <div>
            <h2 className="font-serif text-xl md:text-2xl font-normal tracking-tight sticky mt-16 md:mt-0 top-32">About Me</h2>
          </div>
        ...
        <div className="w-full md:w-1/2 p-6 md:p-10 flex flex-col justify-center md:justify-between">
          <div className="max-w-xl mt-12 md:mt-0">
            ...
            <p className="hidden md:block font-sans text-xl md:text-3xl leading-snug font-light">
              A developer and designer based in Tokyo. I spend my days bridging the gap between what a product looks like and how it actually lives in the hands of a user. Whether I’m tinkering with Framer for animations or Vite for performance, I’m always searching for that "aha!" moment where code becomes an experience.
            </p>

            {/* Mobile Text (Shortened) */}
            <p className="block md:hidden font-sans text-2xl leading-snug font-light">
              A developer and designer based in Tokyo, bridging the gap between design and code to create experiences that feel alive.
            </p>

            <p className="font-sans text-xl md:text-3xl leading-snug font-light mt-8">
              Solutions shaped by structure and restraint.
            </p>
          </div>
